...
const Home = () => {
  return (
    <div className="bg-gray-100 min-h-screen flex items-center overflow-hidden"> {/* Ensure no horizontal scroll */}
      <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center px-4"> {/* Added padding on mobile to prevent content overflow */}
